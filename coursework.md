...
[Скачать презентацию](path/to/your/presentation.pptx)

## Приложение 3: Текстовая речь

Текстовая версия речи, произнесенной во время защиты курсовой работы, доступна в формате .txt.

[Скачать текст речи](path/to/your/speech.txt)

## Приложение 4: SQL-запросы и инсерты

В этом приложении представлены SQL-запросы и инсерты, использованные в процессе разработки базы данных.

[Скачать SQL-запросы](path/to/your/sql_queries.sql)
